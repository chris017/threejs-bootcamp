...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function ha(){return new Vn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ls(),fragmentShader:`
		...
		`,blending:yn,depthTest:!1,depthWrite:!1})}function ua(){return new Vn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ls(),fragmentShader:`
...
`)}function Td(d,t){const e={},n=d.getProgramParameter(t,35721);for(let a=0;a<n;a++){const i=d.getActiveAttrib(t,a),r=i.name;let s=1;i.type===35674&&(s=2),i.type===35675&&(s=3),i.type===35676&&(s=4),e[r]={type:i.type,location:d.getAttribLocation(t,r),locationSize:s}}return e}function Ei(d){return d!==""}function ya(d,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return d.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function wa(d,t){return d.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const Cd=/^[ \t]*#include +<([\w\d./]+)>/gm;function ts(d){return d.replace(Cd,Ld)}function Ld(d,t){const e=Qt[t];if(e===void 0)throw new Error("Can not resolve #include <"+t+">");return ts(e)}const Pd=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function ba(d){return d.replace(Pd,Rd)}function Rd(d,t,e,n){let a="";for(let i=parseInt(t);i<parseInt(e);i++)a+=n.replace(/\[\s*i\s*\]/g,"[ "+i+" ]").replace(/UNROLLED_LOOP_INDEX/g,i);return a}function Ma(d){let t="precision "+d.precision+` float;
...
#define LOW_PRECISION`),t}function Dd(d){let t="SHADOWMAP_TYPE_BASIC";return d.shadowMapType===za?t="SHADOWMAP_TYPE_PCF":d.shadowMapType===Na?t="SHADOWMAP_TYPE_PCF_SOFT":d.shadowMapType===Si&&(t="SHADOWMAP_TYPE_VSM"),t}function Id(d){let t="ENVMAP_TYPE_CUBE";if(d.envMap)switch(d.envMapMode){case ci:case hi:t="ENVMAP_TYPE_CUBE";break;case ar:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Fd(d){let t="ENVMAP_MODE_REFLECTION";if(d.envMap)switch(d.envMapMode){case hi:t="ENVMAP_MODE_REFRACTION";break}return t}function Bd(d){let t="ENVMAP_BLENDING_NONE";if(d.envMap)switch(d.combine){case Va:t="ENVMAP_BLENDING_MULTIPLY";break;case Uo:t="ENVMAP_BLENDING_MIX";break;case Vo:t="ENVMAP_BLENDING_ADD";break}return t}function zd(d){const t=d.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function Nd(d,t,e,n){const a=d.getContext(),i=e.defines;let r=e.vertexShader,s=e.fragmentShader;const c=Dd(e),u=Id(e),l=Fd(e),o=Bd(e),h=zd(e),p=e.isWebGL2?"":Ed(e),g=Ad(i),m=a.createProgram();let f,v,x=e.glslVersion?"#version "+e.glslVersion+`
`:"";e.isRawShaderMaterial?(f=[g].filter(Ei).join(`
`),f.length>0&&(f+=`
`),v=[p,g].filter(Ei).join(`
`),v.length>0&&(v+=`
